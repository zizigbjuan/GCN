...
python train.py --model=pointnet2_cls_ssg_spec_cp --log_dir=spec_cp --num_point=1024 --normal 

# train a model using original pointnet++
#python train.py --model=pointnet2_cls_ssg --log_dir=pointnet --num_point=1024 --normal 
